...
return [
    ...
    'warehouse' => [
        'address_1' => 'Caderea Bastiliei nr 66',
        'address_2' => '',
        'state' => 'Bucuresti',
        'city' => 'Bucuresti',
        'country' => 'RO',
    ...
    'social_facebook' => env('SHOP_SOCIAL_FACEBOOK', 'https://www.facebook.com/dmgartconcept'),
    'social_instagram' => env('SHOP_SOCIAL_INSTAGRAM', 'https://www.instagram.com/dmgartconcept/'),
];